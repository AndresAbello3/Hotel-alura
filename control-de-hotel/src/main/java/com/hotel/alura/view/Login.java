...
public class Login extends JFrame {
	...
	//AQUI INICIAMOS SESION CON EL USUARIO DE LA BASE DE DATOS.
	private void iniciarSesion() {
        ...
        try (Connection connection = connectionFactory.recuperaConexion()) {
            String sql = "SELECT * FROM usuarios_registrados WHERE USUARIO = ? AND CONTRASEÑA = ?";
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
                ...
                try (ResultSet resultSet = preparedStatement.executeQuery()) {
                    ...
                    if (resultSet.next()) {
                        ...
                        GestionDeSesiones.iniciarSesion(usuario); // Iniciar sesión
                        MenuUsuario menu = new MenuUsuario();
        	            menu.setVisible(true);
        	            dispose();	
                        // Agrega aquí la lógica para abrir la siguiente ventana o realizar acciones después de iniciar sesión
                    } else {
            ...
            JOptionPane.showMessageDialog(this, "Lo sentimos, se ha producido un error al iniciar sesión");
            e.printStackTrace();
        }
    } 
